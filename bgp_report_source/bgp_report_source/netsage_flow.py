...
def get_flow_entries(start, end, es_instance):
	...
	query = {"query":{"range":{"start": {"gte":start, "lte":end, "format":"epoch_millis"}}},\
		"size":0, "aggs":{"count_sensor_id":{"cardinality":{"field":"meta.sensor_id"}}}}
	...
	query = {"query":{"range":{"start":{"gte":start, "lte":end, "format":"epoch_millis"}}},\
		"size":0, "aggs":{"group_by_sensor_id":{"terms":{"size":number_of_sensors, "field":"meta.sensor_id"},\
		"aggs":{"group_by_src_ip":{"terms":{"field":"meta.src_ip"},\
